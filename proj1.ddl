...
CREATE TABLE SP16_Curr_Proj
  (
    ...
    Curr_Proj_project_active NUMBER NOT NULL
  ) ;
ALTER TABLE SP16_Curr_Proj ADD CONSTRAINT SP16_Current_Project_PK PRIMARY KEY ( project_no ) ;
...
CREATE TABLE SP16_Mgr
  (
    ...
    Mgr_bonus       INTEGER ,
    employee_id     INTEGER NOT NULL ,
    Mgr_project_no  INTEGER NOT NULL ,
...
CREATE TABLE SP16_Pers
  (
    ...
    Pers_first_name   VARCHAR2 (255) NOT NULL ,
    Pers_last_name    VARCHAR2 (255) NOT NULL ,
    Pers_home_address VARCHAR2 (255) ,
    Pers_zipcode      INTEGER ,
    Pers_home_phone   INTEGER ,
    Pers_us_citizen   NUMBER ,
    Pers_person_id1   INTEGER NOT NULL
  ) ;
CREATE UNIQUE INDEX SP16_Pers__IDX ON SP16_Pers
  (
    Pers_person_id1 ASC
  )
  ;
...
CREATE TABLE SP16_Prev_Proj
  (
    project_no                 INTEGER NOT NULL ,
    Prev_Proj_end_date_month   INTEGER ,
    Prev_Proj_end_date_day     INTEGER ,
    Prev_Proj_end_date_year    INTEGER ,
    Prev_Proj_est_person_hours INTEGER
  ) ;
ALTER TABLE SP16_Prev_Proj ADD CONSTRAINT SP16_Previous_Project_PK PRIMARY KEY ( project_no ) ;


CREATE TABLE SP16_Proj
  (
    Proj_project_no              INTEGER NOT NULL ,
    Proj_project_title           VARCHAR2 (20) NOT NULL ,
    Proj_project_no1             INTEGER ,
    SP16_Dept_SP16_Department_ID NUMBER NOT NULL
  ) ;
ALTER TABLE SP16_Proj ADD CONSTRAINT SP16_Proj_PK PRIMARY KEY ( Proj_project_no ) ;
...
CREATE TABLE SP16_R4
  (
    ...
    SP16_Curr_Proj_project_no INTEGER NOT NULL
  ) ;
ALTER TABLE SP16_R4 ADD CONSTRAINT SP16_R4_PK PRIMARY KEY ( SP16_Proj_Emp_person_id, SP16_Curr_Proj_project_no ) ;


CREATE TABLE SP16_R8
  (
    SP16_Dept_SP16_Department_ID NUMBER NOT NULL ,
    SP16_Proj_Proj_project_no    INTEGER NOT NULL
  ) ;
ALTER TABLE SP16_R8 ADD CONSTRAINT SP16_R8_PK PRIMARY KEY ( SP16_Dept_SP16_Department_ID, SP16_Proj_Proj_project_no ) ;


ALTER TABLE SP16_R1 ADD CONSTRAINT FK_ASS_85 FOREIGN KEY ( SP16_Pers_Pers_person_id ) REFERENCES SP16_Pers ( Pers_person_id ) ;

ALTER TABLE SP16_R1 ADD CONSTRAINT FK_ASS_86 FOREIGN KEY ( SP16_Pers_Pers_person_id1 ) REFERENCES SP16_Pers ( Pers_person_id ) ;

ALTER TABLE SP16_R4 ADD CONSTRAINT FK_ASS_90 FOREIGN KEY ( SP16_Proj_Emp_person_id ) REFERENCES SP16_Proj_Emp ( person_id ) ;

ALTER TABLE SP16_R4 ADD CONSTRAINT FK_ASS_91 FOREIGN KEY ( SP16_Curr_Proj_project_no ) REFERENCES SP16_Curr_Proj ( project_no ) ;

ALTER TABLE SP16_R8 ADD CONSTRAINT FK_ASS_95 FOREIGN KEY ( SP16_Dept_SP16_Department_ID ) REFERENCES SP16_Dept ( SP16_Department_ID ) ;

ALTER TABLE SP16_R8 ADD CONSTRAINT FK_ASS_96 FOREIGN KEY ( SP16_Proj_Proj_project_no ) REFERENCES SP16_Proj ( Proj_project_no ) ;

ALTER TABLE SP16_Curr_Proj ADD CONSTRAINT SP16_Curr_Proj_Proj_FK FOREIGN KEY ( project_no ) REFERENCES SP16_Proj ( Proj_project_no ) ;

ALTER TABLE SP16_Dept ADD CONSTRAINT SP16_Dept_SP16_Mgr_FK FOREIGN KEY ( SP16_Manager_person_id ) REFERENCES SP16_Mgr ( person_id ) ;
...
ALTER TABLE SP16_Mgr ADD CONSTRAINT SP16_Mgr_SP16_Proj_FK FOREIGN KEY ( Mgr_project_no ) REFERENCES SP16_Proj ( Proj_project_no ) ;
...
ALTER TABLE SP16_Prev_Proj ADD CONSTRAINT SP16_Prev_Proj_Project_FK FOREIGN KEY ( project_no ) REFERENCES SP16_Proj ( Proj_project_no ) ;

ALTER TABLE SP16_Proj_Emp ADD CONSTRAINT SP16_Proj_Emp_Emp_FK FOREIGN KEY ( person_id ) REFERENCES SP16_Emp ( person_id ) ;

ALTER TABLE SP16_Proj ADD CONSTRAINT SP16_Proj_SP16_Proj_FK FOREIGN KEY ( Proj_project_no1 ) REFERENCES SP16_Proj ( Proj_project_no ) ;

ALTER TABLE SP16_Pers ADD CONSTRAINT SP16_R1 FOREIGN KEY ( Pers_person_id ) REFERENCES SP16_Pers ( Pers_person_id ) ;

ALTER TABLE SP16_Pers ADD CONSTRAINT SP16_R1v1 FOREIGN KEY ( Pers_person_id1 ) REFERENCES SP16_Pers ( Pers_person_id ) ;

ALTER TABLE SP16_Curr_Proj ADD CONSTRAINT SP16_R4 FOREIGN KEY ( project_no ) REFERENCES SP16_Proj_Emp ( person_id ) ;

ALTER TABLE SP16_Proj_Emp ADD CONSTRAINT SP16_R4v1 FOREIGN KEY ( person_id ) REFERENCES SP16_Curr_Proj ( project_no ) ;
...
ALTER TABLE SP16_Dept ADD CONSTRAINT SP16_R8v1 FOREIGN KEY ( dept_no ) REFERENCES SP16_Proj ( Proj_project_no ) ;
...
CREATE OR REPLACE TRIGGER ARC_FKArc_4_SP16_Curr_Proj BEFORE
  INSERT OR
  UPDATE OF project_no ON SP16_Curr_Proj FOR EACH ROW DECLARE d INTEGER;
  BEGIN
    SELECT A.Proj_project_no
    INTO d
    FROM SP16_Proj A
    WHERE A.Proj_project_no = :new.project_no;
    IF (d                  IS NULL OR d <> project_no) THEN
      raise_application_error(-20223,'FK SP16_Curr_Proj_Proj_FK in Table SP16_Curr_Proj violates Arc constraint on Table SP16_Proj - discriminator column Proj_project_no doesn''t have value project_no');
    END IF;
  EXCEPTION
  WHEN NO_DATA_FOUND THEN
    NULL;
...
CREATE OR REPLACE TRIGGER ARC_FKArc_4_SP16_Prev_Proj BEFORE
  INSERT OR
  UPDATE OF project_no ON SP16_Prev_Proj FOR EACH ROW DECLARE d INTEGER;
  BEGIN
    SELECT A.Proj_project_no
    INTO d
    FROM SP16_Proj A
    WHERE A.Proj_project_no = :new.project_no;
    IF (d                  IS NULL OR d <> project_no) THEN
      raise_application_error(-20223,'FK SP16_Prev_Proj_Project_FK in Table SP16_Prev_Proj violates Arc constraint on Table SP16_Proj - discriminator column Proj_project_no doesn''t have value project_no');
    END IF;
  EXCEPTION
  WHEN NO_DATA_FOUND THEN
    NULL;
...
CREATE OR REPLACE TRIGGER ARC_FKArc_1_SP16_Interim_Mgr BEFORE
  ...
  BEGIN
    ...
    IF (d            IS NULL OR d <> person_id) THEN
      raise_application_error(-20223,'FK SP16_Int_Mgr_Mgr_FK in Table SP16_Interim_Mgr violates Arc constraint on Table SP16_Mgr - discriminator column employee_id doesn''t have value person_id');
    END IF;
  EXCEPTION
  WHEN NO_DATA_FOUND THEN
    NULL;
...
CREATE OR REPLACE TRIGGER ARC_FKArc_1_SP16_Pres BEFORE
  ...
  BEGIN
    ...
    WHERE A.person_id = :new.person_id;
    IF (d            IS NULL OR d <> person_id) THEN
      raise_application_error(-20223,'FK SP16_Pres_Mgr_FK in Table SP16_Pres violates Arc constraint on Table SP16_Mgr - discriminator column employee_id doesn''t have value person_id');
    END IF;
  EXCEPTION
  WHEN NO_DATA_FOUND THEN
    NULL;
